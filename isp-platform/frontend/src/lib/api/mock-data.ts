...
export const mockCustomers: Customer[] = [
  {
    ...
    paymentStatus: "paid",
    balance: 0,
    customerSince: new Date(now - 1000 * 60 * 60 * 24 * 180).toISOString(),
    nextInvoiceDate: new Date(now + 1000 * 60 * 60 * 24 * 21).toISOString(),
    lastPaymentDate: new Date(now - 1000 * 60 * 60 * 24 * 9).toISOString(),
    paymentReference: "PSK-DEMO-001",
    ...
    slaTier: "silver",
    serviceLocation: "Demo Apartment, Lekki",
    routerModel: "ZXHN H196A",
    routerMac: "70:4F:57:AB:22:10",
    onuMac: "70:4F:57:AA:11:10",
    wifiName: "WestLink-Demo",
    tags: ["demo", "residential"],
    supportStatus: "stable",
    notes: [
      {
        id: "note-demo-1",
        author: "Customer Care",
        message: "Customer onboarded as demo account for commercial presentations.",
    ...
    history: [
      {
        id: "hist-demo-1",
        title: "Plan renewal paid",
        description: "Customer renewed Plus 20Mbps plan through Paystack.",
    ...
    installationRecords: [
      {
        id: "inst-demo-1",
        title: "Initial FTTH installation",
        technician: "Bolanle O.",
        scheduledAt: new Date(now - 1000 * 60 * 60 * 24 * 41).toISOString(),
        completedAt: new Date(now - 1000 * 60 * 60 * 24 * 40).toISOString(),
        status: "completed",
        materials: ["1 x ONU", "35m drop cable", "1 x dual-band router"],
      },
    ],
  },
  {
    ...
    accountStatus: "active",
    online: true,
    planName: "Business 20Mbps",
    monthlyFee: 12000,
    paymentStatus: "paid",
    balance: 0,
    customerSince: new Date(now - 1000 * 60 * 60 * 24 * 400).toISOString(),
    nextInvoiceDate: new Date(now + 1000 * 60 * 60 * 24 * 12).toISOString(),
    lastPaymentDate: new Date(now - 1000 * 60 * 60 * 24 * 18).toISOString(),
    paymentReference: "PSK-0001",
    installStatus: "installed",
    ...
    slaTier: "gold",
    serviceLocation: "6 Admiralty Way, Lekki - Block A",
    routerModel: "Huawei AX3 Pro",
    routerMac: "80:6D:97:23:11:AA",
    onuMac: "D8:15:0D:11:AB:22",
    wifiName: "Adebayo-Hub",
    tags: ["business", "vip"],
    supportStatus: "stable",
    notes: [
      {
        id: "note-1001-1",
        author: "Finance",
        message: "Account set to auto-renewal pending live Paystack webhook integration.",
    ...
    history: [
      {
        ...
        description: "ONU activated and business Wi-Fi handed over to customer IT team.",
      ...
      {
        id: "hist-1001-2",
        title: "Support case active",
        description: "Evening speed drops escalated to NOC capacity review.",
    ...
    installationRecords: [
      {
        ...
        technician: "Samuel A.",
        scheduledAt: new Date(now - 1000 * 60 * 60 * 24 * 121).toISOString(),
        completedAt: new Date(now - 1000 * 60 * 60 * 24 * 120).toISOString(),
        status: "completed",
        materials: ["1 x Huawei ONU", "60m armored drop cable", "1 x AX router"],
      },
    ],
  },
  {
    ...
    accountStatus: "active",
    online: false,
    planName: "Business Pro 50Mbps",
    monthlyFee: 20000,
    paymentStatus: "overdue",
    balance: 20000,
    customerSince: new Date(now - 1000 * 60 * 60 * 24 * 240).toISOString(),
    nextInvoiceDate: new Date(now - 1000 * 60 * 60 * 24 * 2).toISOString(),
    lastPaymentDate: new Date(now - 1000 * 60 * 60 * 24 * 36).toISOString(),
    paymentReference: "PSK-0034",
    installStatus: "installed",
    ...
    slaTier: "silver",
    serviceLocation: "11 Prince Yesufu Abiodun, Oniru - Floor 2",
    routerModel: "Nokia Beacon 2",
    routerMac: "08:BD:43:56:AE:10",
    onuMac: "08:BD:43:55:AE:10",
    wifiName: "Marina-View-Staff",
    tags: ["corporate", "overdue", "offline"],
    supportStatus: "needs_attention",
    notes: [
      {
        id: "note-1002-1",
        author: "Customer Care",
        message: "Business customer called twice today regarding outage and pending invoice.",
    ...
    history: [
      {
        ...
        description: "July invoice remains unpaid beyond due date.",
      ...
      },
      {
        ...
        description: "Loss spike on distribution segment escalated to field repair.",
    ...
    installationRecords: [
      {
        id: "inst-1002-1",
        title: "Business fiber deployment",
        technician: "Ibrahim D.",
        scheduledAt: new Date(now - 1000 * 60 * 60 * 24 * 72).toISOString(),
        completedAt: new Date(now - 1000 * 60 * 60 * 24 * 70).toISOString(),
        status: "completed",
        materials: ["1 x Nokia ONU", "95m drop cable", "Patch cords", "Rack patch panel"],
      },
    ],
  },
  {
    ...
    balance: 8500,
    customerSince: new Date(now - 1000 * 60 * 60 * 24 * 20).toISOString(),
    nextInvoiceDate: new Date(now + 1000 * 60 * 60 * 24 * 3).toISOString(),
    ...
    slaTier: "bronze",
    serviceLocation: "Block C24, Ikate Elegushi",
    routerModel: "Genexis XG6846",
    routerMac: "BC:F1:71:19:AA:02",
    onuMac: "BC:F1:71:18:AA:02",
    wifiName: "Korede-Home",
    tags: ["new install", "activation pending"],
    supportStatus: "watch",
    notes: [
      {
        id: "note-1003-1",
        author: "Install Desk",
        message: "Awaiting final installation and first payment confirmation before activation.",
    ...
    history: [
      {
        ...
        description: "Field team booked for customer installation on upcoming slot.",
    ...
    installationRecords: [
      {
        id: "inst-1003-1",
        title: "Pending home installation",
        technician: "Bolanle O.",
        scheduledAt: new Date(now + 1000 * 60 * 60 * 24 * 2).toISOString(),
        status: "scheduled",
        materials: ["1 x Genexis ONU", "80m drop cable", "1 x indoor router"],
        notes: "Customer requested concealed indoor cabling.",
      },
    ],
  },
];
